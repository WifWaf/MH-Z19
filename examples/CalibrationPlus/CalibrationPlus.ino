/* 
    ...
    There is a BIG difference however. Span is a zero command, meaning it takes a reading
    like calibration() does where the CO2 must match the defined span.

    I.e. a span of 2000, needs a CO2 environemnt of 2000 etc.
*/
...
#define EXAMPLE_HAS_SPAN 1   // include span example
